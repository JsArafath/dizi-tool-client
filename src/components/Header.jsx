...
export default function Header({ onCartOpen, onLoginOpen, onAdminOpen }) {
  ...
  const handleSearch = (e) => {
    ...
    if (category && category !== 'SELECT CATEGORY' && category !== t.selectCategory) params.append('cat', category)
  ...
  return (
    <header className="header" id="header">
      <div className="container header-inner">
        ...
        {/* Search Bar */}
        <form onSubmit={handleSearch} style={{ flex: 1, margin: '0 40px', display: 'flex', border: '1px solid #e1e1e1', borderRadius: '4px', overflow: 'hidden' }}>
          <input 
            type="text" 
